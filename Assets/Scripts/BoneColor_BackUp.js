...
var markerLeftElbow:GameObject;
var markerRightElbow:GameObject;
var markerLeftKnee:GameObject;
var markerRightKnee:GameObject;
...
function Update () {
	...
	if(name == "L_Elbow_Rotation"){
		...
		//Debug.Log("difference = " + Mathf.Abs(HandTracker.RyValue - HandTracker.botLyValue));
		//Debug.Log("---------------------------------------------------");
		...
		if(MenuBtn_TextScript.inGame){
			...
			if((playerOffset <= (botOffset) + angleTolerance && playerOffset >= (botOffset) - angleTolerance) && (Mathf.Abs(HandTracker.RyValue - HandTracker.botLyValue) < heightTolerance)) {
		...
		if(MenuBtn_TextScript.inGame){
			...
			if((playerOffset <= (botOffset) + angleTolerance && playerOffset >= (botOffset) - angleTolerance) && (Mathf.Abs(HandTracker.LyValue - HandTracker.botRyValue) < heightTolerance)) {
		...
		*/
		if(MenuBtn_TextScript.inGame){
			...
			if((Mathf.Abs((Mathf.Abs(HandTracker.botLFxValue - HandTracker.botxValue)) - (Mathf.Abs(HandTracker.RFxValue - HandTracker.xValue))) < widthTolerance) && (Mathf.Abs(HandTracker.RFyValue - HandTracker.botLFyValue) < heightTolerance)) {
		...
		*/
		if(MenuBtn_TextScript.inGame){
			...
			if((Mathf.Abs((Mathf.Abs(HandTracker.botRFxValue - HandTracker.botxValue)) - (Mathf.Abs(HandTracker.LFxValue - HandTracker.xValue))) < widthTolerance) && (Mathf.Abs(HandTracker.LFyValue - HandTracker.botRFyValue) < heightTolerance)) {
